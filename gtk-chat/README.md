...
- **v0.4.2 — commands help window.** Help uses a real labeled button via `Adw.ButtonContent`, opens a purpose-built `Commands` window instead of an About window with Details/Legal pages, and keeps `llmmsg-chat v0.4.2` visible in the room subtitle.
